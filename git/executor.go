...
// NewCommandExecutor returns the production Git command executor.
func NewCommandExecutor() CommandExecutor {
	return &DefaultCommandExecutor{executor: executor.NewExecutor()}
}
...
// WithExecutor returns a context whose Git operations use exec.
