...
func GetNzbgetInfo(ctx context.Context, verbose bool) string {
	...
	for i, instance := range nzbgetInstances {
		...
		wg.Add(1)
		go func(idx int, inst UserPassAppInstance) {
			defer wg.Done()
...
func callNzbgetAPI(ctx context.Context, instance UserPassAppInstance, method string, target any) error {
...
func getNzbgetQueueInfo(ctx context.Context, instance UserPassAppInstance) (NzbgetInfo, error) {
