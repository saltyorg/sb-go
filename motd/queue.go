...
func getSonarrQueueDetailed(ctx context.Context, instance AppInstance, verbose bool) (QueueInfo, error) {
	if verbose {
...
func getRadarrQueueDetailed(ctx context.Context, instance AppInstance, verbose bool) (QueueInfo, error) {
	if verbose {
...
func getLidarrQueueDetailed(ctx context.Context, instance AppInstance, verbose bool) (QueueInfo, error) {
	if verbose {
...
func getReadarrQueueDetailed(ctx context.Context, instance AppInstance, verbose bool) (QueueInfo, error) {
	if verbose {
